...
export default function AuthPage() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse 120% 90% at 50% 0%, oklch(0.18 0.04 265) 0%, oklch(0.10 0.015 255) 50%, oklch(0.08 0.012 260) 100%)",
      }}
    >
      {/* Animated orbs */}
      <div
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-8">
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 20px oklch(0.45 0.22 265 / 0.4), 0 4px 12px rgba(0,0,0,0.3)",
            }}
          >
            <svg
              width="24"
        ...
        <button
          ...
          style={{
            background: isBusy
              ? "oklch(0.30 0.10 265)"
              : "linear-gradient(135deg, oklch(0.48 0.22 265) 0%, oklch(0.42 0.20 255) 50%, oklch(0.55 0.18 200) 100%)",
            color: "white",
            boxShadow: isBusy
              ? "none"
        ...
        >
          {BENEFITS.map((benefit, i) => (
            ...
            >
              ...
              <span className="text-sm font-body text-foreground/80 leading-snug">
                {benefit}
              </span>
            </div>
          ))}
