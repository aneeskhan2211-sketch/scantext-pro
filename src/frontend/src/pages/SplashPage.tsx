...
export default function SplashPage() {
  ...
  useEffect(() => {
    ...
    const t3 = setTimeout(() => setDotsVisible(true), 1000);
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse 120% 80% at 50% 0%, oklch(0.22 0.06 270) 0%, oklch(0.12 0.01 250) 55%, oklch(0.09 0.015 260) 100%)",
      }}
    >
      {/* Ambient orbs */}
      <div
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.55 0.2 270) 0%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.62 0.18 170) 0%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.5 0.15 220) 0%, transparent 70%)",
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.45 0.22 265) 0%, oklch(0.35 0.18 255) 100%)",
            boxShadow:
              "0 0 40px oklch(0.45 0.22 265 / 0.5), 0 8px 24px rgba(0,0,0,0.4)",
          }}
        >
        ...
        {DOTS.map((i) => (
          <div
            ...
            style={{
              ...
              boxShadow:
                activeDot === i
                  ? "0 0 12px oklch(0.72 0.18 200 / 0.6)"
                  : "none",
            }}
          />
        ))}
