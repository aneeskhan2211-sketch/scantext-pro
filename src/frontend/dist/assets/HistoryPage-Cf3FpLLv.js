import { c as createLucideIcon, u as useNavigate, r as reactExports, j as jsxRuntimeExports, d as ue, e as cn, i as SkeletonList, k as Clock } from "./index-BQ7M_1jd.js";
import { E as EmptyState } from "./EmptyState-CB0EkCF_.js";
...
import { u as useListScans, b as useDeleteScan, c as useRestoreScan, d as useToggleFavorite } from "./useScans-Zgp6jEjj.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 z-20 bg-card/95 backdrop-blur-md border-b border-border/60 px-4 pt-12 pb-3 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          activeFilter === "trash" && scans.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "bg-card border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display text-foreground", children: "Empty Trash?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { className: "text-muted-foreground font-body", children: [
