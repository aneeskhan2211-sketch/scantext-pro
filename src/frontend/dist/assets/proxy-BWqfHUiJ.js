import { r as reactExports, j as jsxRuntimeExports } from "./index-CLbxCJ0J.js";
...
async function performOCR(imageDataUrl, options = {}) {
...
async function performLocalOCR(_imageDataUrl, language, onProgress) {
  onProgress == null ? void 0 : onProgress(30);
  await delay$1(400);
  onProgress == null ? void 0 : onProgress(70);
  await delay$1(400);
...
async function performCloudOCR(imageDataUrl, language, onProgress) {
  onProgress == null ? void 0 : onProgress(20);
  const base64 = imageDataUrl.split(",")[1];
  onProgress == null ? void 0 : onProgress(40);
