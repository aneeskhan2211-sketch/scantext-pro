import { u as useNavigate, r as reactExports, j as jsxRuntimeExports, k as Clock, i as SkeletonList } from "./index-BQ7M_1jd.js";
import { B as Badge } from "./badge-Br30magA.js";
import { e as useSearchScans } from "./useScans-Zgp6jEjj.js";
import { A as ArrowLeft } from "./arrow-left-DcoT0o12.js";
import { S as Search } from "./search-BMP118ei.js";
import { X } from "./x-Cr5a-IY-.js";
import { C as CircleAlert, R as RefreshCw } from "./refresh-cw-Du3xXI_g.js";
...
function SearchPage() {
  ...
  const showNoResults = !!query && !isLoading && !isError && (!results || results.length === 0);
  const showResults = !!query && !isLoading && !isError && results && results.length > 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background pb-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-4 space-y-3", children: [
      ...
      showError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-display font-semibold text-foreground", children: "Search failed" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Something went wrong while searching. Please try again." })
            ] }),
